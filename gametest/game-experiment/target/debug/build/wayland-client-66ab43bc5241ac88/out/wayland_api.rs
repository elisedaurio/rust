...
pub struct WlDisplay { ptr: *mut wl_proxy, alive: Arc<AtomicBool> }
...
unsafe fn from_ptr_new(ptr: *mut wl_proxy) -> WlDisplay {
            ...
            WlDisplay { ptr: ptr, alive: (&*data).1.clone() }
        }
unsafe fn from_ptr_initialized(ptr: *mut wl_proxy) -> WlDisplay {
            let data = ffi_dispatch!(WAYLAND_CLIENT_HANDLE, wl_proxy_get_user_data, ptr) as *mut (*mut c_void, Arc<AtomicBool>);
            WlDisplay { ptr: ptr, alive: (&*data).1.clone() }
        }
...
fn is_alive(&self) -> bool { self.alive.load(::std::sync::atomic::Ordering::SeqCst) }
...
pub fn sync(&self)-> RequestResult<super::wl_callback::WlCallback> {
...
/// compositor.
pub fn get_registry(&self)-> RequestResult<super::wl_registry::WlRegistry> {
if !self.is_alive() { return RequestResult::Destroyed }
...
use std::os::raw::c_void;
use wayland_sys::client::*;
pub struct WlRegistry { ptr: *mut wl_proxy, alive: Arc<AtomicBool> }
...
unsafe fn from_ptr_new(ptr: *mut wl_proxy) -> WlRegistry {
            let data = Box::into_raw(Box::new((ptr::null_mut::<c_void>(), Arc::new(AtomicBool::new(true)))));
            ffi_dispatch!(WAYLAND_CLIENT_HANDLE, wl_proxy_set_user_data, ptr, data as *mut c_void);
            WlRegistry { ptr: ptr, alive: (&*data).1.clone() }
        }
...
pub fn bind<T: Proxy>(&self, version: u32, name: u32)-> RequestResult<T> {
if !self.is_alive() { return RequestResult::Destroyed }
...
use std::os::raw::c_void;
use wayland_sys::client::*;
pub struct WlCallback { ptr: *mut wl_proxy, alive: Arc<AtomicBool> }
...
unsafe fn from_ptr_new(ptr: *mut wl_proxy) -> WlCallback {
            let data = Box::into_raw(Box::new((ptr::null_mut::<c_void>(), Arc::new(AtomicBool::new(true)))));
            ffi_dispatch!(WAYLAND_CLIENT_HANDLE, wl_proxy_set_user_data, ptr, data as *mut c_void);
            WlCallback { ptr: ptr, alive: (&*data).1.clone() }
        }
...
use std::os::raw::c_void;
use wayland_sys::client::*;
pub struct WlCompositor { ptr: *mut wl_proxy, alive: Arc<AtomicBool> }
...
unsafe fn from_ptr_new(ptr: *mut wl_proxy) -> WlCompositor {
            let data = Box::into_raw(Box::new((ptr::null_mut::<c_void>(), Arc::new(AtomicBool::new(true)))));
            ffi_dispatch!(WAYLAND_CLIENT_HANDLE, wl_proxy_set_user_data, ptr, data as *mut c_void);
            WlCompositor { ptr: ptr, alive: (&*data).1.clone() }
        }
...
pub fn create_surface(&self)-> RequestResult<super::wl_surface::WlSurface> {
if !self.is_alive() { return RequestResult::Destroyed }
...
pub fn create_region(&self)-> RequestResult<super::wl_region::WlRegion> {
if !self.is_alive() { return RequestResult::Destroyed }
...
use std::os::raw::c_void;
use wayland_sys::client::*;
pub struct WlShmPool { ptr: *mut wl_proxy, alive: Arc<AtomicBool> }
...
unsafe fn from_ptr_new(ptr: *mut wl_proxy) -> WlShmPool {
            let data = Box::into_raw(Box::new((ptr::null_mut::<c_void>(), Arc::new(AtomicBool::new(true)))));
            ffi_dispatch!(WAYLAND_CLIENT_HANDLE, wl_proxy_set_user_data, ptr, data as *mut c_void);
            WlShmPool { ptr: ptr, alive: (&*data).1.clone() }
        }
...
use std::os::raw::c_void;
use wayland_sys::client::*;
pub struct WlShm { ptr: *mut wl_proxy, alive: Arc<AtomicBool> }
...
unsafe fn from_ptr_new(ptr: *mut wl_proxy) -> WlShm {
            let data = Box::into_raw(Box::new((ptr::null_mut::<c_void>(), Arc::new(AtomicBool::new(true)))));
            ffi_dispatch!(WAYLAND_CLIENT_HANDLE, wl_proxy_set_user_data, ptr, data as *mut c_void);
            WlShm { ptr: ptr, alive: (&*data).1.clone() }
        }
...
pub fn create_pool(&self, fd: ::std::os::unix::io::RawFd, size: i32)-> RequestResult<super::wl_shm_pool::WlShmPool> {
if !self.is_alive() { return RequestResult::Destroyed }
...
use std::os::raw::c_void;
use wayland_sys::client::*;
pub struct WlBuffer { ptr: *mut wl_proxy, alive: Arc<AtomicBool> }
...
unsafe fn from_ptr_new(ptr: *mut wl_proxy) -> WlBuffer {
            let data = Box::into_raw(Box::new((ptr::null_mut::<c_void>(), Arc::new(AtomicBool::new(true)))));
            ffi_dispatch!(WAYLAND_CLIENT_HANDLE, wl_proxy_set_user_data, ptr, data as *mut c_void);
            WlBuffer { ptr: ptr, alive: (&*data).1.clone() }
        }
...
use std::os::raw::c_void;
use wayland_sys::client::*;
pub struct WlDataOffer { ptr: *mut wl_proxy, alive: Arc<AtomicBool> }
...
unsafe fn from_ptr_new(ptr: *mut wl_proxy) -> WlDataOffer {
            let data = Box::into_raw(Box::new((ptr::null_mut::<c_void>(), Arc::new(AtomicBool::new(true)))));
            ffi_dispatch!(WAYLAND_CLIENT_HANDLE, wl_proxy_set_user_data, ptr, data as *mut c_void);
            WlDataOffer { ptr: ptr, alive: (&*data).1.clone() }
        }
...
use std::os::raw::c_void;
use wayland_sys::client::*;
pub struct WlDataSource { ptr: *mut wl_proxy, alive: Arc<AtomicBool> }
...
unsafe fn from_ptr_new(ptr: *mut wl_proxy) -> WlDataSource {
            let data = Box::into_raw(Box::new((ptr::null_mut::<c_void>(), Arc::new(AtomicBool::new(true)))));
            ffi_dispatch!(WAYLAND_CLIENT_HANDLE, wl_proxy_set_user_data, ptr, data as *mut c_void);
            WlDataSource { ptr: ptr, alive: (&*data).1.clone() }
        }
...
use std::os::raw::c_void;
use wayland_sys::client::*;
pub struct WlDataDevice { ptr: *mut wl_proxy, alive: Arc<AtomicBool> }
...
unsafe fn from_ptr_new(ptr: *mut wl_proxy) -> WlDataDevice {
            let data = Box::into_raw(Box::new((ptr::null_mut::<c_void>(), Arc::new(AtomicBool::new(true)))));
            ffi_dispatch!(WAYLAND_CLIENT_HANDLE, wl_proxy_set_user_data, ptr, data as *mut c_void);
            WlDataDevice { ptr: ptr, alive: (&*data).1.clone() }
        }
...
use std::os::raw::c_void;
use wayland_sys::client::*;
pub struct WlDataDeviceManager { ptr: *mut wl_proxy, alive: Arc<AtomicBool> }
...
unsafe fn from_ptr_new(ptr: *mut wl_proxy) -> WlDataDeviceManager {
            let data = Box::into_raw(Box::new((ptr::null_mut::<c_void>(), Arc::new(AtomicBool::new(true)))));
            ffi_dispatch!(WAYLAND_CLIENT_HANDLE, wl_proxy_set_user_data, ptr, data as *mut c_void);
            WlDataDeviceManager { ptr: ptr, alive: (&*data).1.clone() }
        }
...
///
/// Create a new data source.
pub fn create_data_source(&self)-> RequestResult<super::wl_data_source::WlDataSource> {
if !self.is_alive() { return RequestResult::Destroyed }
...
pub fn get_data_device(&self, seat: &super::wl_seat::WlSeat)-> RequestResult<super::wl_data_device::WlDataDevice> {
if !self.is_alive() { return RequestResult::Destroyed }
...
use std::os::raw::c_void;
use wayland_sys::client::*;
pub struct WlShell { ptr: *mut wl_proxy, alive: Arc<AtomicBool> }
...
unsafe fn from_ptr_new(ptr: *mut wl_proxy) -> WlShell {
            let data = Box::into_raw(Box::new((ptr::null_mut::<c_void>(), Arc::new(AtomicBool::new(true)))));
            ffi_dispatch!(WAYLAND_CLIENT_HANDLE, wl_proxy_set_user_data, ptr, data as *mut c_void);
            WlShell { ptr: ptr, alive: (&*data).1.clone() }
        }
...
pub fn get_shell_surface(&self, surface: &super::wl_surface::WlSurface)-> RequestResult<super::wl_shell_surface::WlShellSurface> {
if !self.is_alive() { return RequestResult::Destroyed }
...
use std::os::raw::c_void;
use wayland_sys::client::*;
pub struct WlShellSurface { ptr: *mut wl_proxy, alive: Arc<AtomicBool> }
...
unsafe fn from_ptr_new(ptr: *mut wl_proxy) -> WlShellSurface {
            let data = Box::into_raw(Box::new((ptr::null_mut::<c_void>(), Arc::new(AtomicBool::new(true)))));
            ffi_dispatch!(WAYLAND_CLIENT_HANDLE, wl_proxy_set_user_data, ptr, data as *mut c_void);
            WlShellSurface { ptr: ptr, alive: (&*data).1.clone() }
        }
...
/// the surface (e.g. fullscreen or maximized).
pub fn resize(&self, seat: &super::wl_seat::WlSeat, serial: u32, edges: Resize)-> RequestResult<()> {
if !self.is_alive() { return RequestResult::Destroyed }
...
pub fn set_toplevel(&self)-> RequestResult<()> {
if !self.is_alive() { return RequestResult::Destroyed }
...
pub fn set_transient(&self, parent: &super::wl_surface::WlSurface, x: i32, y: i32, flags: Transient)-> RequestResult<()> {
if !self.is_alive() { return RequestResult::Destroyed }
...
/// be made fullscreen.
pub fn set_fullscreen(&self, method: FullscreenMethod, framerate: u32, output: Option<&super::wl_output::WlOutput>)-> RequestResult<()> {
if !self.is_alive() { return RequestResult::Destroyed }
...
/// corner of the surface relative to the upper left corner of the
/// parent surface, in surface-local coordinates.
pub fn set_popup(&self, seat: &super::wl_seat::WlSeat, serial: u32, parent: &super::wl_surface::WlSurface, x: i32, y: i32, flags: Transient)-> RequestResult<()> {
if !self.is_alive() { return RequestResult::Destroyed }
...
pub fn set_maximized(&self, output: Option<&super::wl_output::WlOutput>)-> RequestResult<()> {
if !self.is_alive() { return RequestResult::Destroyed }
...
pub fn set_class(&self, class_: String)-> RequestResult<()> {
if !self.is_alive() { return RequestResult::Destroyed }
...
use std::os::raw::c_void;
use wayland_sys::client::*;
pub struct WlSurface { ptr: *mut wl_proxy, alive: Arc<AtomicBool> }
...
unsafe fn from_ptr_new(ptr: *mut wl_proxy) -> WlSurface {
            let data = Box::into_raw(Box::new((ptr::null_mut::<c_void>(), Arc::new(AtomicBool::new(true)))));
            ffi_dispatch!(WAYLAND_CLIENT_HANDLE, wl_proxy_set_user_data, ptr, data as *mut c_void);
            WlSurface { ptr: ptr, alive: (&*data).1.clone() }
        }
...
use std::os::raw::c_void;
use wayland_sys::client::*;
pub struct WlSeat { ptr: *mut wl_proxy, alive: Arc<AtomicBool> }
...
unsafe fn from_ptr_new(ptr: *mut wl_proxy) -> WlSeat {
            let data = Box::into_raw(Box::new((ptr::null_mut::<c_void>(), Arc::new(AtomicBool::new(true)))));
            ffi_dispatch!(WAYLAND_CLIENT_HANDLE, wl_proxy_set_user_data, ptr, data as *mut c_void);
            WlSeat { ptr: ptr, alive: (&*data).1.clone() }
        }
...
use std::os::raw::c_void;
use wayland_sys::client::*;
pub struct WlPointer { ptr: *mut wl_proxy, alive: Arc<AtomicBool> }
...
unsafe fn from_ptr_new(ptr: *mut wl_proxy) -> WlPointer {
            let data = Box::into_raw(Box::new((ptr::null_mut::<c_void>(), Arc::new(AtomicBool::new(true)))));
            ffi_dispatch!(WAYLAND_CLIENT_HANDLE, wl_proxy_set_user_data, ptr, data as *mut c_void);
            WlPointer { ptr: ptr, alive: (&*data).1.clone() }
        }
...
use std::os::raw::c_void;
use wayland_sys::client::*;
pub struct WlKeyboard { ptr: *mut wl_proxy, alive: Arc<AtomicBool> }
...
unsafe fn from_ptr_new(ptr: *mut wl_proxy) -> WlKeyboard {
            let data = Box::into_raw(Box::new((ptr::null_mut::<c_void>(), Arc::new(AtomicBool::new(true)))));
            ffi_dispatch!(WAYLAND_CLIENT_HANDLE, wl_proxy_set_user_data, ptr, data as *mut c_void);
            WlKeyboard { ptr: ptr, alive: (&*data).1.clone() }
        }
...
use std::os::raw::c_void;
use wayland_sys::client::*;
pub struct WlTouch { ptr: *mut wl_proxy, alive: Arc<AtomicBool> }
...
unsafe fn from_ptr_new(ptr: *mut wl_proxy) -> WlTouch {
            let data = Box::into_raw(Box::new((ptr::null_mut::<c_void>(), Arc::new(AtomicBool::new(true)))));
            ffi_dispatch!(WAYLAND_CLIENT_HANDLE, wl_proxy_set_user_data, ptr, data as *mut c_void);
            WlTouch { ptr: ptr, alive: (&*data).1.clone() }
        }
...
use std::os::raw::c_void;
use wayland_sys::client::*;
pub struct WlOutput { ptr: *mut wl_proxy, alive: Arc<AtomicBool> }
...
unsafe fn from_ptr_new(ptr: *mut wl_proxy) -> WlOutput {
            let data = Box::into_raw(Box::new((ptr::null_mut::<c_void>(), Arc::new(AtomicBool::new(true)))));
            ffi_dispatch!(WAYLAND_CLIENT_HANDLE, wl_proxy_set_user_data, ptr, data as *mut c_void);
            WlOutput { ptr: ptr, alive: (&*data).1.clone() }
        }
...
use std::os::raw::c_void;
use wayland_sys::client::*;
pub struct WlRegion { ptr: *mut wl_proxy, alive: Arc<AtomicBool> }
...
unsafe fn from_ptr_new(ptr: *mut wl_proxy) -> WlRegion {
            let data = Box::into_raw(Box::new((ptr::null_mut::<c_void>(), Arc::new(AtomicBool::new(true)))));
            ffi_dispatch!(WAYLAND_CLIENT_HANDLE, wl_proxy_set_user_data, ptr, data as *mut c_void);
            WlRegion { ptr: ptr, alive: (&*data).1.clone() }
        }
...
use std::os::raw::c_void;
use wayland_sys::client::*;
pub struct WlSubcompositor { ptr: *mut wl_proxy, alive: Arc<AtomicBool> }
...
unsafe fn from_ptr_new(ptr: *mut wl_proxy) -> WlSubcompositor {
            let data = Box::into_raw(Box::new((ptr::null_mut::<c_void>(), Arc::new(AtomicBool::new(true)))));
            ffi_dispatch!(WAYLAND_CLIENT_HANDLE, wl_proxy_set_user_data, ptr, data as *mut c_void);
            WlSubcompositor { ptr: ptr, alive: (&*data).1.clone() }
        }
...
use std::os::raw::c_void;
use wayland_sys::client::*;
pub struct WlSubsurface { ptr: *mut wl_proxy, alive: Arc<AtomicBool> }
...
unsafe fn from_ptr_new(ptr: *mut wl_proxy) -> WlSubsurface {
            let data = Box::into_raw(Box::new((ptr::null_mut::<c_void>(), Arc::new(AtomicBool::new(true)))));
            ffi_dispatch!(WAYLAND_CLIENT_HANDLE, wl_proxy_set_user_data, ptr, data as *mut c_void);
            WlSubsurface { ptr: ptr, alive: (&*data).1.clone() }
        }
